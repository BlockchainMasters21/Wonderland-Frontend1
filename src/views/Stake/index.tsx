                    ...
                    <Grid className="stake-card-grid" container direction="column" spacing={2}>
                        <Grid item>
                            <div className="stake-card-header">
                                <p className="stake-card-header-title">ACME Staking (🎩, 🎩)</p>
                                <RebaseTimer />
                            </div>
                        </Grid>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="stake-card-index">
                                            ...
                                            <p className="stake-card-metrics-value">{currentIndex ? <>{trim(Number(currentIndex), 2)} MSAA</> : <Skeleton width="150px" />}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="stake-card-area">
                            {!address && (
                                <div className="stake-card-wallet-notification">
                                    ...
                                    <p className="stake-card-wallet-desc-text">Connect your wallet to stake ACME tokens!</p>
                                </div>
                            )}
                            {address && (
                                <div>
